...
import 'package:base_flutter/core/core.dart';
...
class AppState {
  ...
  static Future<void> initialize() async {
    try {
      ...
      isGuestMode = await SharedPrefHelper.getBool(StorageKeys.isGuestMode);
        ...
        if (googleLogin) {
          ...
          if (tokens != null) {
            ...
            if (!isExpired) {
              ...
              if (apiService != null) {
                hasValidSession = await TokenManager.attemptTokenRefresh(
                  apiService,
                );
                if (hasValidSession) {
