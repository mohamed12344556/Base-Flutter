...
class ApiFileService {
  ...
  Future<Map<String, dynamic>> uploadProfileImage(File imageFile) async {
    try {
      developer.log(
        'Uploading profile image: ${imageFile.path}',
        name: 'ApiFileService',
      );
  ...
  Future<Map<String, dynamic>> createQuestion({
    ...
    try {
      developer.log('Creating question: $title', name: 'ApiFileService');
      ...
      final response = await _dio.post(ApiConstants.questions, data: formData);

      developer.log('Question created successfully', name: 'ApiFileService');
      return response.data as Map<String, dynamic>;
    } catch (e, stackTrace) {
      BaseLogger.e('Error creating question', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> updateQuestion({
    ...
    try {
      developer.log('Updating question: $questionId', name: 'ApiFileService');
      ...
      BaseLogger.e('Error updating question', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> addReaction({
    ...
    try {
      ...
      BaseLogger.e('Error adding reaction', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> removeReaction({
    ...
    try {
      ...
      BaseLogger.e('Error removing reaction', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }

  Future<Map<String, dynamic>> uploadTeacherDocument({
    required File file,
    ...
    try {
      developer.log(
        'Uploading teacher document: $fileType - ${file.path}',
        name: 'ApiFileService',
      );
      ...
      final response = await _dio.post(
        ApiConstants.teacherDocuments,
        data: formData,
        onSendProgress: onProgress,
      );

      developer.log(
        'Teacher document uploaded successfully: $fileType',
        name: 'ApiFileService',
      );
      return response.data as Map<String, dynamic>;
    } catch (e, stackTrace) {
      BaseLogger.e(
        'Error uploading teacher document',
        error: e,
        stackTrace: stackTrace,
      );
      rethrow;
